...
#define STEP_MOTOR_GPIO_EN 34
#define STEP_MOTOR_GPIO_DIR 35
#define STEP_MOTOR_GPIO_STEP 36
...
void app_main(void)
{
    ...
    // set: clk source, tx gpio, mem, resolution, trans_queue, | get "channel_handle"
    ...
    const static uint32_t accel_samples = 50;
    const static uint32_t uniform_speed_hz = 7000;
    const static uint32_t decel_samples = 50;
